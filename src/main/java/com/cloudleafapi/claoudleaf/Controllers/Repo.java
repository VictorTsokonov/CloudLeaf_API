...
public class Repo {
	...
	public RepoEntity createRepo(@RequestParam String userID,
			@RequestParam String repoName, @RequestParam String cloneUrl,
			@RequestParam String sshUrl, @RequestParam(required = false) String status) {
	...
	@PutMapping("/status")
	public void updateRepoStatusByRepoName(@RequestParam String repoName,
			@RequestParam String status) {
		repoService.updateRepoStatusByRepoName(repoName, status);
	}

	@PutMapping("/ipaddress")
	public void updateRepoIpAddressByRepoName(@RequestParam String repoName,
			@RequestParam String ipAddress) {
		repoService.updateRepoIpAddressByRepoName(repoName, ipAddress);
	}

	@PutMapping("/ipAndStatus")
	public void updateRepoIpAndStatusByRepoName(@RequestParam String repoName,
			@RequestParam String ipAddress, @RequestParam String status) {
		repoService.updateRepoIpAddressByRepoName(repoName, ipAddress);
		repoService.updateRepoStatusByRepoName(repoName, status);
	}
